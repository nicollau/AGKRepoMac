...
bool ImGui::ScrollbarEx(const ImRect& bb_frame, ImGuiID id, ImGuiAxis axis, ImS64* p_scroll_v, ImS64 size_visible_v, ImS64 size_contents_v, ImDrawFlags draw_rounding_flags)
{
    ...
    // AGK: optional scrollbar arrow buttons handling (may shrink 'bb')
    ImGui::ScrollbarArrowState _agk_arrow_state{};
    ImGui::ScrollbarAddArrows_Pre(bb, axis, (ImS64*)p_scroll_v, size_visible_v, size_contents_v, &_agk_arrow_state);
    ...
    // AGK: render arrow buttons on top if used
    ImGui::ScrollbarAddArrows_Post(_agk_arrow_state, axis);
